...
public final class Constants {
    ...
    // Labels
    public static final String LABEL_TRANSFER_FROM = "Transfer from Portfolio:";
    public static final String LABEL_TRANSFER_TO = "Transfer to Portfolio:";
    public static final String LABEL_TRANSFER_TYPE = "Type of Transfer:";
    ...
    // Error messages
    public static final String ERROR_SELECT_STOCK = "Select a stock.";
    public static final String ERROR_TITLE = "Error";
    public static final String ERROR_CONTROLLER_NOT_INITIALIZED = "Transfer controller not initialized";
